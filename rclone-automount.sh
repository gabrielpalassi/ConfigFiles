...
[Service]
Type=oneshot
ExecStart=/usr/bin/notify-send --app-name="iCloud Drive" --urgency=critical --icon=dialog-error "iCloud Drive Mount Failed" "Please run 'rclone reconnect' to fix the issue."
